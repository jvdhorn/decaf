...
* [dials/dxtbx](https://github.com/dials/dxtbx?tab=readme-ov-file): used for reading crystallographic image files
* numpy
* scipy
* matplotlib
...
* `tls_in` - result of the [ECHT](https://www.nature.com/articles/s41467-021-25814-x) B-factor distribution (json)
