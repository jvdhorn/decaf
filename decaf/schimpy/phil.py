  ...
  schimpy
    {
        ...
        .help = "Input files and parameters"
      {
        ...
        max_chains = 9e999
          .type = float
          .help = 'Only apply displacements to this number of chains'
        pick_extremes = None
          .type = floats
        ...
        .help = "Correlation parameters"
      {
        ...
        intra_only = []
          .type = ints
          .help = 'Ignore intermolecular interactions for these levels'
        energy_percentile = 0
          .type = float
        ...
        adopt = None
          .type = ints
          .help = 'Copy conformation from chain a to chain b'
        force_power = 2.
          .type = float
